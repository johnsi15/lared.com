	...
	<script>
      $(document).ready(function() {
		  ...
		  $('#buscar').live('keyup',function(){
		  	   var data = 'buscarInternet='+$(this).val();
		  	     //console.log(data);
      	       if(data =='buscarInternet='){
...
<body>
	...
	<article class="container well" id="fondo">
		...
		<div class="row">
			<aside><h1>Internet Por Concepto</h1></aside><br><br>
