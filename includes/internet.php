	...
	<article class="container well" id="fondo">
				...
				<div class="container">
					...
					<div class="nav-collapse">
						<ul class="nav">
							...
							<li class="active"><a href="internet.php">Internet</a></li>
		...
		<div class="row">
			<?php
               ...
               if($objeto->consultaInternet()){//si nos devuelve verdadero se desabilitan los campos
               ?><!--si hay base del dia se desabilitan los campos-->
                    <script>
				       $(document).ready(function(){
              ...
              <?php
               }else{/* si no hay datos entonces se desabilita el boton de guardar para que no guarden nada si no hasta que inserten la base del dia*/
               	   ?>
                      <script>
				       $(document).ready(function(){
					 ...
					 <div id="mimodal" class="modal hide fade">
					 	...
					 	<div class="modal-body">
					 		 <form action="acciones.php" method="post" class="form-inline" id="validate">
							    ...
							    <input type="hidden" name="tipoBase" value="internet">
